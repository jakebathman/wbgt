{{--
    ...
    level 1 is outlined, level 2 is hatched, level 3 is solid.
    Expects the hatch patterns from <x-chance-icon-defs /> to be on the page.
--}}
...
<svg
    {{ $attributes->class(['inline-block size-4 align-middle', $icon['color']]) }}
    viewBox="0 0 24 24"
    fill="{{ $fill }}"
    stroke="currentColor"
    stroke-width="1.75"
